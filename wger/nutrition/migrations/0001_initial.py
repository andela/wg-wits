    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protein',
                 models.DecimalField(help_text='In g per 100g of product',
                ...
                ('sodium',
                 models.DecimalField(decimal_places=3,
                                     ...
                                     null=True,
                                     verbose_name='Sodium')),
                ('language', models.ForeignKey(editable=False,
                                               to='core.Language', verbose_name='Language')),
                ('license', models.ForeignKey(default=2,
                                              verbose_name='License', to='core.License')),
                ('user', models.ForeignKey(blank=True, editable=False,
                                           to=settings.AUTH_USER_MODEL, null=True, verbose_name='User')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.IntegerField(verbose_name='Order',
                                              max_length=1, editable=False, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.IntegerField(verbose_name='Order',
                                              max_length=1, editable=False, blank=True)),
                ('amount',
                 models.DecimalField(verbose_name='Amount',
                                     max_digits=6,
                                     decimal_places=2,
                ...
                ('meal', models.ForeignKey(editable=False,
                                           to='nutrition.Meal', verbose_name='Nutrition plan')),
                ('weight_unit', models.ForeignKey(verbose_name='Weight unit',
                                                  blank=True, to='nutrition.IngredientWeightUnit', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
