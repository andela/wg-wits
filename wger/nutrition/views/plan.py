...
def export_pdf(request, id, uidb64=None, token=None):
    ...
    * http://www.reportlab.com/apis/reportlab/dev/platypus.html
    ...
    data = []
    data.append([
        Paragraph(u'<para align="center">{0}</para>'.format(_('Nutritional data')),
                  styleSheet["Bold"])])
    ...
    data.append(
        [Paragraph(_('Carbohydrates'), styleSheet["Normal"]),
         ...
         Paragraph(six.text_type(plan_data['percent']['carbohydrates']),
                   styleSheet["Normal"]),
         Paragraph(
             six.text_type(plan_data['per_kg']['carbohydrates']),
            styleSheet["Normal"])])
    ...
    data.append([Paragraph(_('Fibres'), styleSheet["Normal"]),
                 Paragraph(six.text_type(
                     plan_data['total']['fibres']),
        styleSheet["Normal"])])
    data.append([Paragraph(_('Sodium'),
                           styleSheet["Normal"]),
                 Paragraph(six.text_type(
