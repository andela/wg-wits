    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(related_name='adminusernote_member',
                                             editable=False, to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(related_name='adminusernote_user',
                                           editable=False, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.CharField(max_length=100,
                                           null=True, verbose_name='Owner', blank=True)),
                ('zip_code', models.IntegerField(max_length=5,
                                                 null=True, verbose_name='ZIP code', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gym', models.OneToOneField(
                    related_name='config', editable=False, to='gym.Gym')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name',
                 models.CharField(help_text='Will use file name if nothing provided',
                                  max_length=60,
                                  verbose_name='Name',
                                  blank=True)),
                ('note', models.TextField(null=True, verbose_name='Note', blank=True)),
                ('member', models.ForeignKey(related_name='userdocument_member',
                                             editable=False, to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(related_name='userdocument_user',
                                           editable=False, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-timestamp_created'],
