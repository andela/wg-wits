    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        verbose_name='Author',
                        blank=True)),
                ('status', models.CharField(default=b'1', max_length=2, editable=False, choices=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exercise', models.ForeignKey(editable=False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default=b'1', max_length=2, editable=False, choices=[
                 (b'1', 'Pending'), (b'2', 'Accepted'), (b'3', 'Declined')])),
                ('image',
                 models.ImageField(help_text='Only PNG and JPEG formats are supported',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID',
                                        serialize=False, auto_created=True, primary_key=True)),
                ('name',
                 models.CharField(help_text='In latin, e.g. "Pectoralis major"',
                                  max_length=50,
                                  verbose_name='Name')),
