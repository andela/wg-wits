    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url',
                 models.URLField(help_text='Link to license text or other information',
                                 null=True,
                                 verbose_name='Link',
                                 blank=True)),
            ],
            ...
            fields=[
                ...
                ('height',
                 models.IntegerField(max_length=2,
                                     ...
                                     validators=[django.core.validators.MinValueValidator(140),
                                                 django.core.validators.MaxValueValidator(230)])),
                ('gender', models.CharField(default=b'1', max_length=1,
                                            null=True, choices=[(b'1', 'Male'), (b'2', 'Female')])),
                ('sleep_hours',
                 models.IntegerField(default=7,
                ...
                ('weight_unit',
                 models.CharField(default=b'kg',
                                  ...
                                  choices=[(b'kg',
                                           ...
                                           (b'lb',
                                            'Imperial (pound)')])),
                ('gym', models.ForeignKey(blank=True,
                                          editable=False, to='gym.Gym', null=True)),
                ('notification_language', models.ForeignKey(default=2, verbose_name='Notification language', to='core.Language',
