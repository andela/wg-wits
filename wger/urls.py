...
router.register(
    r'workout',
    manager_api_views.WorkoutViewSet,
    base_name='workout')
router.register(
    r'workoutsession',
...
router.register(
    r'schedule',
    manager_api_views.ScheduleViewSet,
    base_name='schedule')
...
router.register(
    r'setting',
    manager_api_views.SettingViewSet,
    base_name='Setting')
router.register(
    r'workoutlog',
    manager_api_views.WorkoutLogViewSet,
    base_name='workoutlog')

# Core app
router.register(
    r'userprofile',
    core_api_views.UserProfileViewSet,
    base_name='userprofile')
router.register(
    r'language',
    core_api_views.LanguageViewSet,
    base_name='language')
router.register(
    r'daysofweek',
    core_api_views.DaysOfWeekViewSet,
...
router.register(
    r'weightunit',
    nutrition_api_views.WeightUnitViewSet,
...
router.register(
    r'mealitem',
    nutrition_api_views.MealItemViewSet,
    base_name='mealitem')
