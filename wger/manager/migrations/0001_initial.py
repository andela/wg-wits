    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'description',
                    models.CharField(
                        help_text='Ususally a description about what parts are trained, like "Arms" or "Pull Day"',
                        max_length=100,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'name',
                    models.CharField(
                        help_text="Name or short description of the schedule. For example 'Program XYZ'.",
                        max_length=100,
                        verbose_name='Name')),
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text='Tick the box if you want to mark this schedule as your active one (will be shown e.g. on your dashboard). All other schedules will then be marked as inactive',
                        verbose_name='Schedule active')),
                (
                    'is_loop',
                    models.BooleanField(
                        default=False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID',
                                        serialize=False, auto_created=True, primary_key=True)),
                ('reps',
                 models.IntegerField(verbose_name='Repetitions',
                                     validators=[django.core.validators.MinValueValidator(0),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'comment',
                    models.CharField(
                        help_text="A short description or goal of the workout. For example 'Focus on back' or 'Week 1 of program xy'.",
                        max_length=100,
                        verbose_name='Description',
                        blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID',
                                        serialize=False, auto_created=True, primary_key=True)),
                ('reps', models.IntegerField(verbose_name='Repetitions',
                                             validators=[django.core.validators.MinValueValidator(0)])),
                ('weight',
                 models.DecimalField(verbose_name='Weight',
                                     max_digits=5,
                                     decimal_places=2,
                                     validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_start', models.TimeField(null=True,
                                                verbose_name='Start time', blank=True)),
                ('time_end', models.TimeField(null=True,
                                              verbose_name='Finish time', blank=True)),
                ('user', models.ForeignKey(
                    verbose_name='User', to=settings.AUTH_USER_MODEL)),
                ('workout', models.ForeignKey(
                    verbose_name='Workout', to='manager.Workout')),
